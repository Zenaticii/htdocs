												...
												<div class="kt-widget__body">
													<div class="kt-widget__content">
														<div class="kt-widget__info">
															...
															<a href="#" class="kt-widget__data">'.$_SESSION["email"].'</a>
														</div>
														<div class="kt-widget__info">
													...
													<div class="kt-widget__items">      
														<a href="'.$links.'profile/overview" class="kt-widget__item'.$active_profile_overview.'">
														...
														<a href="'.$links.'profile/personal-info" class="kt-widget__item'.$active_profile_personal_info.'">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink=" http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="'.$links.'profile/account-info" class="kt-widget__item'.$active_profile_account_info.'">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="'.$links.'profile/change-pass" class="kt-widget__item'.$active_profile_change_pass.'">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="'.$links.'profile/email-settings" class="kt-widget__item'.$active_profile_email_settings.'">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
